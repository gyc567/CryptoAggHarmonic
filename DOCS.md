...
Permanent documentation. See [AGENTS.md](AGENTS.md) → Documentation for rules.
...
- [Agent Setup](docs/agents/issue-tracker.md)
...
- [Maker-Checker Audit](docs/maker-checker-architecture-audit-and-optimization.md)
